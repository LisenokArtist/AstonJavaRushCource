package com.example.demo.Core.Beans.Kafka.User;
...
public class UserConfig {
    ...
    public ConsumerFactory<String, UserEvent> userConsumerFactory(){
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.example.demo.Core.DataModels.Events.User");
        return new DefaultKafkaConsumerFactory<>(props);
    }

    @Bean(name=UserConfig.LISTENERCONTAINERFACTORY)
